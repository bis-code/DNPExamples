...
namespace TodoWithLoginFeature.Authentication.Impl
{
    public class CustomeAuthenticationStateProvider : AuthenticationStateProvider
    {
        ...
        public CustomeAuthenticationStateProvider(IJSRuntime jsRuntime, IUserService userService)
        {
        ...
        private ClaimsIdentity SetupClaimsForUser(User user)
        {
            ...
            claims.Add(new Claim("BirthYear", user.Birthday.ToString()));
